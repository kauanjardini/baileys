...
const TimedOutError = (stack) => new BaileysError('tempo acabou', { status: 408 }, stack);
exports.TimedOutError = TimedOutError;
const CancelledError = (stack) => new BaileysError('cancelado', { status: 500 }, stack);
