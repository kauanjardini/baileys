...
class WAConnection extends _7_MessagesExtra_1.WAConnection {
    constructor() {
       ...
       /////Encerrar grupo
       this.deletarGrupo = async (jid) => {
            const response = await this.groupQuery('delete', jid);
        ...
        *Atualizar a descrição do grupo
         */
         this.atualizarDescrição = async (jid, description) => {
        ...
        this.addGrupo = (jid, participants) => this.groupQuery('add', jid, null, participants);
 /**
        ...
        this.removerGrupo = (jid, participants) => this.groupQuery('remove', jid, null, participants);
        /**
        ...
        this.darAdm = (jid, participants) => this.groupQuery('promote', jid, null, participants);
        /**
        ...
        this.tirarAdm = (jid, participants) => this.groupQuery('demote', jid, null, participants);
        /**
         * Make demote an admin on the group
         * @param jid the ID of the group
         * @param participants the people to make admin
