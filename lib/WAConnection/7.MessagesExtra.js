...
class WAConnection extends _6_MessagesSend_1.WAConnection {
     ...
     */
    async getDevice(id){
    const deviceType = id.length > 21 ? 'android' : id.substring(0, 2) === '3A' ? 'ios' : 'whatsapp web';
    return deviceType;
};
     /**
     * Marca o chat com read/unread; para ler e desler as msg
     * Parametro jig é o id do grupo
     */
